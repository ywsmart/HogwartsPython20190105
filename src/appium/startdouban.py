...
'''
bottoms  = driver.find_elements_by_id("com.douban.frodo:id/title")
print bottoms

for button in bottoms:
    print button.text
    if button.text == u"我的":
        pass
        #button.click()
...
#my = driver.find_element_by_android_uiautomator('new UiSelector().text(u"我的")')
#my.click()
